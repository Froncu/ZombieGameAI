...
void SurvivalAgentPlugin::Initialize(IBaseInterface* pInterface, PluginInfo& info)
{
	...
	info.Student_Name = "JAKUB FRATCZAK"; //No special characters allowed. Highscores won't work with special characters.
	info.Student_Class = "2DAE00";
	info.LB_Password = "BigBoss04!";//Don't use a real password! This is only to prevent other students from overwriting your highscore!
}
